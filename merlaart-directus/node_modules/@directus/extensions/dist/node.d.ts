...
declare function defineHook<Custom extends CustomConfig<HookConfig>>(config: ExtendedConfig<HookConfig, Custom>): ExtendedConfig<HookConfig, Custom>;
declare function defineEndpoint<Custom extends CustomConfig<EndpointConfig>>(config: ExtendedConfig<EndpointConfig, Custom>): ExtendedConfig<EndpointConfig, Custom>;
